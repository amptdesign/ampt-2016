        ...
        $css  = '<style type="text/css">'. "\n";
            ...
            */
            if( ot_get_option('ut_site_border', 'hide' ) == 'show' ) { 
                ...
                if( !is_home() ) {
                    ...
                    $css .= '#wrapper_mbYTP_ut-background-video-hero { min-width: calc(100% - 60px) !important; left:30px !important; }';
            ...
            */
            if( ot_get_option('ut_top_header' , 'hide' ) == 'show' ) { 
                ...
                /* hero size */
                $css .= '#ut-hero{ height: calc(100% - 30px) !important; min-height: calc(100% - 30px) !important; }';
