			...
			*/
            ...
            <div class="xml">
                ...
                <label class="ut-choose-demo-img" for="demo_fourteen">
                    <img src="<?php echo THEME_WEB_ROOT; ?>/admin/assets/images/importer/brooklyn-demo14.jpg" />
                </label>
...
if ( !function_exists( 'ut_demo_importer' ) ) {
	...
	function ut_demo_importer() {
		...
		$ut_recognized_file_names = apply_filters( 'ut_recognized_file_names', array( 
		  'demo_one', 'demo_two' , 'demo_two_b' , 'demo_three', 'demo_four', 'demo_five', 'demo_six' , 'demo_seven' , 'demo_eight' , 'demo_eight_b' , 'demo_nine', 'demo_ten', 'demo_eleven' , 'demo_twelve' , 'demo_thirteen' , 'demo_fourteen'
		));
